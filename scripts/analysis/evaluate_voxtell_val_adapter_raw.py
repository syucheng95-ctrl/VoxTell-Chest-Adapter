...
ADAPTER_DIR = ROOT / "outputs" / "voxtell_val_adapter_raw"
OUTPUT_PATH = ROOT / "outputs" / "voxtell_val_adapter_raw_metrics.json"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare raw baseline vs raw+adapter on ReXGroundingCT val.")
    ...
    for case in cases:
        ...
        adapter_items = json.loads(adapter_summary_path.read_text(encoding="utf-8"))["items"]
    ...
    for mode in ("raw_baseline", "raw_adapter"):
