...
from voxtell.model.chest_masked_risk_refine_adapter import ChestMaskedRiskRefineAdapter
from voxtell.model.voxtell_model import VoxTellModel


class VoxTellV66AdapterModel(nn.Module):
    """
    v6.6 wrapper:
    - keeps the v6.4/v6.5 logit-level adapter path
    - adds masked risk suppression
    - turns refine into uncertainty-guided local cleanup
    """
    ...
    def __init__(
        ...
        self.text_guided_adapter = ChestMaskedRiskRefineAdapter(
