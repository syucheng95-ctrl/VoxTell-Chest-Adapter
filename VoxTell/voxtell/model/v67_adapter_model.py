...
from voxtell.model.chest_candidate_selective_risk_refine_adapter import (
    ChestCandidateSelectiveRiskRefineAdapter,
)
from voxtell.model.voxtell_model import VoxTellModel


class VoxTellV67AdapterModel(nn.Module):
    """
    v6.7 wrapper:
    - stays on the v6.5 logit-level adapter backbone
    - softens risk with candidate-aware selective suppression
    - keeps refine as a weak uncertainty-driven cleanup head
    """
    ...
    def __init__(
        ...
        super().__init__()
        self.adapter_version = "v6_7"
        self.base_model = base_model
        self.adapter_insertion_point = adapter_insertion_point
        self.text_guided_adapter = ChestCandidateSelectiveRiskRefineAdapter(
