...
from voxtell.model.chest_candidate_risk_refine_adapter import ChestCandidateRiskRefineAdapter
from voxtell.model.voxtell_model import VoxTellModel


class VoxTellV65AdapterModel(nn.Module):
    """
    v6.5 wrapper:
    - keeps v6.4 logit-level candidate/risk path
    - adds a bounded serial refine head to stabilize risky positives
    """
    ...
    def __init__(
        ...
        self.text_guided_adapter = ChestCandidateRiskRefineAdapter(
