...
class ChestCandidateRiskAdapter(nn.Module):
    """
    v6.4 adapter:
    - no longer enhances encoder/decoder features directly
    - weak category bias only affects candidate proposal
    - candidate head works purely in logit space
    - risk head audits local candidate responses in logit space
    """
    ...
    def rectify_logits(
        ...
        return candidate_logits - self.risk_scale * risk_logit
